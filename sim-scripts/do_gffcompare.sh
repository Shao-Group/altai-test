...
gffcompare -r $al2sp_gtf   -o $d/$prefix.allele1spec.altai  $altai_dir/altai.$prefix.allele2spec.multi-exon.gtf
...
gffcompare -r $al2_gtf     -o $d/$prefix.allele2.sc2      $scallop_dir/scallop2.$prefix.allele1.gtf
gffcompare -r $al1sp_gtf   -o $d/$prefix.allele1spec.sc2  $scallop_dir/scallop2.$prefix.allele1spec.gtf
gffcompare -r $al2sp_gtf   -o $d/$prefix.allele1spec.sc2  $scallop_dir/scallop2.$prefix.allele2spec.gtf
